...
import { t as require_prop_types } from "./prop-types-BN7XkUS9.js";
//#region node_modules/qr.js/lib/ErrorCorrectLevel.js
var require_ErrorCorrectLevel = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = {
		L: 1,
		M: 0,
		Q: 3,
...
var require__8BitByte = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_RSBlock = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_BitBuffer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_math = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var QRMath = {
		glog: function(n) {
...
var require_Polynomial = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	QRPolynomial.prototype = {
		...
		multiply: function(e) {
			...
			for (var i = 0; i < this.getLength(); i++) for (var j = 0; j < e.getLength(); j++) num[i + j] ^= math.gexp(math.glog(this.get(i)) + math.glog(e.get(j)));
...
var require_util = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var QRUtil = {
		...
		getErrorCorrectPolynomial: function(errorCorrectLength) {
			...
			for (var i = 0; i < errorCorrectLength; i++) a = a.multiply(new Polynomial([1, math.gexp(i)], 0));
			return a;
		},
...
var require_QRCodeSvg = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var QRCodeSvg = (0, _react.forwardRef)(function(_ref, ref) {
		var bgColor = _ref.bgColor, bgD = _ref.bgD, fgD = _ref.fgD, fgColor = _ref.fgColor, size = _ref.size, title = _ref.title, viewBoxSize = _ref.viewBoxSize, _ref$xmlns = _ref.xmlns, xmlns = _ref$xmlns === void 0 ? "http://www.w3.org/2000/svg" : _ref$xmlns, props = _objectWithoutProperties(_ref, [
			"bgColor",
			"bgD",
			"fgD",
			"fgColor",
...
var require_lib = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _propTypes2 = _interopRequireDefault(require_prop_types());
	var _ErrorCorrectLevel2 = _interopRequireDefault(require_ErrorCorrectLevel());
	var _QRCode2 = _interopRequireDefault(require_QRCode());
	var _react = require_react();
	var _react2 = _interopRequireDefault(_react);
	var _QRCodeSvg2 = _interopRequireDefault(require_QRCodeSvg());
	function _interopRequireDefault(obj) {
		return obj && obj.__esModule ? obj : { default: obj };
	}
	function _objectWithoutProperties(obj, keys) {
	...
	var QRCode = (0, _react.forwardRef)(function(_ref, ref) {
		...
		var binaryString = bytesToBinaryString(encodeStringToUtf8Bytes(value));
